...
class SPSParser {
  /**
   * @REF https://zhuanlan.zhihu.com/p/347059348
   * remove 0x03 after 0x0000
   * EBSP use 0x00000301 to replace 0x000001 in order to
   * avoid 0x01 in data body
   */
  ...
  static parseSPS(uint8array: Uint8Array) {
    ...
    // seq_parameter_set_id (1 uev, see 9.1)
    gb.readUEG();

    console.warn('profile', profile_idc);
    console.warn('level', level_idc);
